...
export const projectsData: Project[] = [
  {
    ...
    gallery: [
      ...
      "/pulse-media/pulsemedia3.png",
      "/pulse-media/pulsemedia5.png",
    ],
  },
  {
    id: "hvac-website",
  ...
  },
  {
    ...
    platform: "mobile",
    summary:
      "BOB is a digital banking platform that enables businesses to manage their finances online—covering payments, payroll, bill settlements, and real-time transaction monitoring in a secure, centralized system.",
    challenge:
      "BOB is a digital banking platform that enables businesses to manage their finances online—covering payments, payroll, bill settlements, and real-time transaction monitoring in a secure, centralized system.",
    solution:
      "BOB is a digital banking platform that enables businesses to manage their finances online—covering payments, payroll, bill settlements, and real-time transaction monitoring in a secure, centralized system.",
    techStack: ["Swift", "UIKit", "Storyboard"],
    coverImage: "/bob/bob1.jpeg",
    gallery: ["/bob/bob1.jpeg", "/bob/bob2.jpeg", "/bob/bob3.jpeg"],
  },
  {
    id: "family-finance-mobile",
